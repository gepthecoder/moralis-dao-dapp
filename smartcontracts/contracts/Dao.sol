...
contract CyberDao {
    ...
    constructor() {
        ...
        validTokens = [102432214047623065579877441936962877221106994973455125140481204099781660508161];
    }
    ...
    // emits when a proposal is created
    ...
    // using valid token array list we check if the account has a positive balance of valid token nfts
    ...
    // can an address vote ? -> part of the pool of addresses that held an elegible nft at the time of creating a proposal
